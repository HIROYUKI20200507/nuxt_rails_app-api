...
class UserTest < ActiveSupport::TestCase
  ...
  test "name_validation" do
    # 入力必須
    user = User.new(email: "test@exsample.com", password: "password")
    user.save
  ...
  test "active_user_uniqueness" do
    ...
    # アクティブなユーザーがいない場合、同じメールアドレスが登録できるか
    count = 3
    ...
    # アクティブなユーザーがいる場合、バリデーションエラーを吐いているか
    ...
    # アクティブなユーザーがいなくなった場合、ユーザーは保存できているのか
    active_user.destroy!
    assert_difference("User.count", 1) do
